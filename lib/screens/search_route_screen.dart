  ...
  Future<void> _useCurrentLocation() async {
    ...
    try {
      if (!await Geolocator.isLocationServiceEnabled()) {
        _showLocationMessage('Turn on location services to use your current location.');
        return;
      }
      ...
      if (permission == LocationPermission.deniedForever) {
        _showLocationMessage('Location permission is permanently denied. Enable it in Settings.');
        return;
      }
      ...
      if (!mounted) return;
      setState(() {
        _origin = 'Current location (${position.latitude.toStringAsFixed(4)}, ${position.longitude.toStringAsFixed(4)})';
        _searched = false;
      });
    } catch (_) {
      _showLocationMessage('We could not get your location. Try again or check your device settings.');
    } finally {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Search for a stop, neighbourhood, or landmark.', style: TextStyle(color: AppColors.textBody)),
                  ...
                  Flexible(
                    child: ListView(
                      ...
                      children: [
                        ...
                        if (query.isNotEmpty && !matches.any((destination) => destination.toLowerCase() == query.toLowerCase()))
                          ListTile(
                            contentPadding: EdgeInsets.zero,
                      ...
                      children: [
                        ...
                        FadeInUp(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              borderRadius: BorderRadius.circular(12),
                              onTap: _gettingCurrentLocation ? null : _useCurrentLocation,
                              child: Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          _destination == null ? 'To: Select destination' : 'To: $_destination',
                                          style: TextStyle(
                                            color: _destination == null ? AppColors.textGrey : AppColors.textDark,
                                            fontSize: 14,
                        ...
                        FadeInUp(
                          ...
                          child: ElevatedButton(
                            onPressed: _destination == null ? null : () async {
                              if (AppRuntime.firebaseAvailable) {
                                await TransitRepository().createTripRequest(
                                  origin: _origin,
